...
class Huobi(exchanges.SpotCCXTExchange):
    CONNECTOR_CONFIG_CLASS = HuobiConnectorSettings
    ...
    async def create_order(self, order_type: octobot_trading.enums.TraderOrderType, symbol: str, quantity: decimal.Decimal,
                           price: decimal.Decimal = None, stop_price: decimal.Decimal = None,
                           side: octobot_trading.enums.TradeOrderSide = None, current_price: decimal.Decimal = None,
        ...
        if order_type is octobot_trading.enums.TraderOrderType.BUY_MARKET:
